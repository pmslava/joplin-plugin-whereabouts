...
// These libraries are provided to content scripts at runtime by Joplin's module require shim
// (real @codemirror/* + @codemirror/state singletons shared with the host editor). They must NOT be
// bundled: bundling a second copy of @codemirror/state breaks `instanceof` checks against the host
// editor's classes. So we declare them as commonjs externals for the extra-script (content-script)
// builds only. Pattern copied from bwat47/joplin-heading-navigator + cqroot/joplin-outline.
